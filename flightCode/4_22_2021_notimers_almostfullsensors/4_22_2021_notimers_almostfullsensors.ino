...
void loop() {
  ...
  //Serial2.println(currentTs);

  //altCorrection = 144;
  //altCorrection  = 41; //for fake data, simulation mode
  
  //INTERVAL TO GET SENSOR DATA
  if((currentTs - sensorDelayStart) > sensorDelayNum){
    //Serial2.println("start of get sens data");
   ...
   // alt = 44330*(1 - pow((pres/SEALEVELPRESSURE_HPA), (1/5.255)));
    ...
    previousAlts[currentAltPos] = currentAlt;
    if(currentAltPos == 9){
      currentAltPos = 0;
    }else{
      currentAltPos++;
    ...
    //Serial2.println("end of get sens data");
    //Serial2.println(String(millis()));
  }

  //INTERVAL TO GET GPS DATA
  if((currentTs - gpsDelayStart) > gpsDelayNum){
    //Serial2.println("start of gps data");
    //Serial2.println(String(millis()));
    ...
    gpsDelayStart = millis();
    //Serial2.println("end of gps data");
    //Serial2.println(String(millis()));
  ...
  if((currentTs - printDelayStart) > printDelayNum){
    //Serial2.println("start of print to xbee");
    //Serial2.println(String(millis()));
    printToXbee();
    printDelayStart = millis();
    //Serial2.println("end of get sens data");
  ...
  if((currentTs - readDelayStart) > readDelayNum){
    //Serial2.println("start of read xbee");
    //Serial2.println(String(millis()));
     recvWithStartEndMarkers();
     showNewData();
     readDelayStart = millis();
     //Serial2.println("end of read xbee");
    //Serial2.println(String(millis()));
   }

   if((currentTs - altCheckDelayStart) > altCheckDelayNum){
    //Serial2.println("start of alt check");
    //Serial2.println(String(millis()));
     altitudeCheck();
     altCheckDelayStart = millis();
     //Serial2.println("end of get sens data");
